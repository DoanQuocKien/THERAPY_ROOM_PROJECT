...
==============================================================================================================
1     B1.02               1.0000            0.1429         0.8571         0.8000         
2     A-F2-RIGHT-ROOM-01  0.4767            0.0000         1.0000         0.6668         
3     A-F1-TOP-ROOM-01    0.9980            1.0000         0.0000         0.4993         
4     C103                0.0000            0.3530         0.6292         0.3676         
==============================================================================================================
```

*   **Nhận xét phân tích Đánh đổi (Rule-based Trade-off):**
    *   **B1.02 (Hạng 1 - Final Score: 0.8000):** Đạt điểm tiếp cận tuyệt đối (1.00), độ riêng tư cao (0.86), độ hiển thị vừa phải (0.14). Đây là căn phòng tối ưu nhất theo cấu hình trọng số ưu tiên riêng tư $50\%$.
    *   **A-F1-TOP-ROOM-01 (Hạng 3 - Final Score: 0.4993):** Độ hiển thị tối đa (1.00) và tiếp cận xuất sắc (0.99), nhưng điểm riêng tư bằng $0.0$ do nằm sát tuyến hành lang chính đông đúc. Hệ thống tự động cảnh báo: *"Mật độ giao thông rất lớn (952 lượt). Yêu cầu lắp đặt vách cách âm, rèm che và biển báo hạn chế tụ tập."*
    *   **C103 (Hạng 4 - Final Score: 0.3676):** Khoảng cách đi lại trung bình lớn (WTC = 245.6m). Hệ thống tự động cảnh báo: *"Vị trí xa giảng đường chính, cần thiết lập sơ đồ hướng dẫn tại sảnh chính."*
